...
class SolarForecastService:
    ...
    def create_pv_system(
        ...
        if azimuth is None:
            ...
            logger.info(
                f"Using azimuth: {azimuth}° (North-facing for southern hemisphere)"
            )
    ...
    def generate_forecast(
        ...
        logger.info(
            f"Generating solar forecast: {start} to {end}, capacity={capacity}kW"
        )
        ...
        pdc = capacity * (poa["poa_global"] / 1000 * (1 + gamma_pdc * (temp_cell - 25)))
